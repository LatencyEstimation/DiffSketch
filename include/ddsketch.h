 ...
 */
template<int relative_accuracy>
 ...
 public:
    ...
    explicit DDSketch()
        : BaseDDSketch<DenseStore, LogarithmicMapping>(
            LogarithmicMapping((double)relative_accuracy/100.0),
            DenseStore(),
            DenseStore()) {
    }
};
 ...
 * (cf. http://www.vldb.org/pvldb/vol12/p2195-masson.pdf)
 */
template<int relative_accuracy, Index bin_limit>
class LogCollapsingLowestDenseDDSketch
 ...
 public:
    ...
    //                                           Index bin_limit)
    explicit LogCollapsingLowestDenseDDSketch()
